    ...
    <section id="productDetails" class="pb-5">
        ...
        <div class="card mt-5 hoverable">
            <div class="row mt-5">
                ...
                <div class="col-lg-5 mr-3 text-right text-md-right">
                    <h2 class="h2-responsive text-right text-md-right product-name font-weight-bold dark-grey-text mb-1 ml-xl-0 ml-4">
                        <strong>{{ $product->name }} </strong>
                    </h2>
                    <h3 class="h3-responsive text-right text-md-right mb-5 ml-xl-0 ml-4">
                            <span class="red-text font-weight-bold">
                                <strong>قیمت محصول : {{ $product->price }} تومان </strong>
                            </span>
                    </h3>

                    <p class="ml-xl-0 ml-4 text-right">{{ $product->description }} </p>
                    <p class="ml-xl-0 ml-4 text-right">
                    ...
                    <section class="color">
                        <div class="mt-5">
                            <p class="grey-text text-right">رنگ :</p>
